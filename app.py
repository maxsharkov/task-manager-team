...
STRATEGIC_AREAS = ["Здоровье", "Семья", "Работа", "Технологии", "Люди", "Мышление", "Творчество", "Деньги", "Публичность", "Система"]
...
STRATEGIC_SEED = [
    ...
    # ── Технологии ────────────────────────────────────────────
    ("Создать AI-экзоскелет жизни и работы — набор агентов: сказал=сделал, информирование", "Технологии"),
    ("Покупать инновационные гаджеты и подписки", "Технологии"),
    ("Научиться работать из любой точки мира", "Технологии"),
    ("Создать собственный цифровой продукт — сайт, продвижение через Claude, организовать путешествие", "Технологии"),
    ("Построить систему управления знаниями — регулярно пересматривать ТОП10 навыков", "Технологии"),
    ("Подготовить платформу консультанта/эксперта", "Технологии"),
    ("Создать новую карьерную свободу", "Технологии"),
    ("Создать следующий уровень возможностей на 10 лет вперёд", "Технологии"),
    # ── Люди ──────────────────────────────────────────────────
    ...
    # ── Творчество ────────────────────────────────────────────
    ("Путешествие каждые 3 месяца — особенно в новые места", "Творчество"),
    ("Ходить на концерты и выставки", "Творчество"),
    ("Природа — каждую неделю обязательно", "Творчество"),
    ("Раз в месяц мини-путешествие", "Творчество"),
    ("Эндуро раз в месяц", "Творчество"),
    ("Продолжить барабаны и музыку — выступить с песней летом", "Творчество"),
    ("Создать список «Пока не сыграл в ящик» — было и будет", "Творчество"),
    ("Жить часть времени рядом с морем", "Творчество"),
    ("Добавить творчество в повседневность", "Творчество"),
    ("Делать жизнь менее предсказуемой — оставлять место для приключения", "Творчество"),
    # ── Деньги ────────────────────────────────────────────────
    ...
    # ── Система ───────────────────────────────────────────────
    ("Сделать обещания себе священными", "Система"),
    ("Разделять, что даёт энергию, а что забирает", "Система"),
    ("Каждый день делать то, что боишься — превращать страх в радость", "Система"),
    ("Управлять вниманием как главным ресурсом — весь мир внутри меня", "Система"),
    ("Отдавать миру — каждый день помогать, поддерживать", "Система"),
    ("Осознанность = пауза перед действием", "Система"),
    ("Соединить эмоциональное и рациональное «зачем»", "Система"),
    ("Быть честным с собой", "Система"),
    ("Весь опыт делится на приятный и полезный — думай позитивно", "Система"),
    ("Цель — свобода перемещения, общения, занятия", "Система"),
    ("Всё проще, чем кажется", "Система"),
    ("Амплитуда эмоций", "Система"),
    ("Жизнь не такая уж серьёзная штука", "Система"),
    ("Я — солнце, светящаяся точка. Свет — отдавать энергию. Точка — всё просто.", "Система"),
]
...
[если есть активные записи за 7 дней — перечисли их дословно, не более 3 на блок]:
  • {{текст записи}} [{{дата}}]

Если активных записей нет — строку «Сделано» не добавляй.
